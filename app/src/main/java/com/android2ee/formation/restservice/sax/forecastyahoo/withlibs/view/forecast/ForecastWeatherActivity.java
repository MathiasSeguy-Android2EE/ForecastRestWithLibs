...
public class ForecastWeatherActivity extends NavigationActivity {
    ...
    **********************************************************/
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        indeterminateDecorator=new IndeterminateStateWidgetDecorator(findViewById(R.id.lil_main_forecast));
    ...
    private void updateArrayAdapter(List<WeatherForecatsItemWithMainAndWeathers> weatherForecatsItemWithMainAndWeathers){
        ...
        if(weatherForecatsItemWithMainAndWeathers==null||weatherForecatsItemWithMainAndWeathers.size()==0){
            ...
            rcv_forecast.setVisibility(View.GONE);
        }else{
            //not empty case
            txvEmptyCase.setVisibility(View.GONE);
            rcv_forecast.setVisibility(View.VISIBLE);
