 ...
 * <ul>
 * <li>CityService</li>
 * <li>com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.service.city</li>
 * <li>08/03/2016</li>
 * <p/>
 * <li>======================================================</li>
 * <p/>
...
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.com.retrofit.ConnectedDataCommunication;
...
public class CityService extends MotherBusinessService implements CityServiceIntf {
    ...
    private void findCityByNameSync(String cityName) {
        if(cityName!=null) {
            ...
            //in that case just clear the livedata
            //it handles the initialization of the view case
            liveFindCitiesResponse.postValue(null);
        }
    }
