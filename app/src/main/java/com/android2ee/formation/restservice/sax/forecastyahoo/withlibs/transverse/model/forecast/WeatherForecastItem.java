...
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.transverse.model.Rain;
...
@Entity(tableName="weather_forecast_item",
        ...
        foreignKeys = {
                @ForeignKey(entity = com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.transverse.model.current.City.class,
                        parentColumns = "_id",
                        childColumns = "cityId",
