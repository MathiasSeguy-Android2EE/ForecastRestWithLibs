...
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.view.current.adapter.WeatherRecyclerViewAdapter;
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.view.current.main.MainCardView;
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.view.current.sys.SysCardView;
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.view.current.weather_data.WeatherDataBeaconCardView;
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.view.dialog.DeleteAlert;
...
//        setContentView(R.layout.activity_current_content);
    ...
    protected void onStop() {
        ...
        if(atomicBombAnim!=null&&atomicBombAnim.isRunning()){
            atomicBombAnim.stop();
        }
    }
    ...
    private void startAVDAnimation(Drawable drawable) {
        if((!ActivityManagerCompat.isLowRamDevice((ActivityManager) getSystemService(Context.ACTIVITY_SERVICE)))
